...
// Usage (with named returns):
//
//	func (d *X) Rpc(ctx context.Context, req *csi.SomeRequest) (resp *csi.SomeResponse, err error) {
//	    defer MakeCSIPanicRecoveryWithError(logger, metricPusher, "X.Rpc", dims, &err, codes.Internal)()
//	    ...
//	}
func MakeCSIPanicRecoveryWithError(
